...
export function getSessionStorageArray(key) {
...
export function reorderSessionStorageArray(key, value) {
    let list = getSessionStorageArray(key);
    const index = list.indexOf(value);
    if (index > -1) {
        list.splice(index, 1);
    }
...
export function removeFromSessionStorageArray(key, value) {
    let list = getSessionStorageArray(key);
    const index = list.indexOf(value);
    if (index > -1) {
        list.splice(index, 1);
